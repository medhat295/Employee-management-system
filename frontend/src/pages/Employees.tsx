        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" placeholder="Jane Smith" className={fieldCls(!!errors.name)}
                {...register('name', { required: 'Required' })} />
              <Err msg={errors.name?.message} />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Email <span className="text-red-500">*</span></label>
              <input type="email" placeholder="jane@company.com" className={fieldCls(!!errors.email)}
                {...register('email', {
                  required: 'Required',
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="tel" placeholder="+1 555 000 0000" className={fieldCls(!!errors.mobile)}
                {...register('mobile', { required: 'Required' })} />
              <Err msg={errors.mobile?.message} />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Address</label>
              <input type="text" placeholder="123 Main St" className={fieldCls(false)} {...register('address')} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" placeholder="Software Engineer" className={fieldCls(!!errors.title)}
            ...
            <div>
              ...
              <input type="date" className={fieldCls(!!errors.hire_date)}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                disabled={!isAdmin}
                className={[fieldCls(!!errors.company), !isAdmin && 'opacity-70 cursor-not-allowed'].filter(Boolean).join(' ')}
                {...register('company', {
          ...
          <div>
            ...
            <select
              ...
              className={[fieldCls(!!errors.department), !watchedCompany && 'opacity-70 cursor-not-allowed'].filter(Boolean).join(' ')}
              {...register('department', {
                required: 'Required', valueAsNumber: true,
          ...
          {!isEdit && (
            <div className="grid grid-cols-2 gap-4 pt-1 border-t border-gray-100">
              <div>
                ...
                <input type="password" placeholder="Min. 8 characters" className={fieldCls(!!errors.initial_password)}
              ...
              <div>
                ...
                <input type="password" placeholder="Repeat password" className={fieldCls(!!errors.confirm_password)}
    ...
    <Modal maxWidth="md">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">Email <span className="text-red-500">*</span></label>
            <input type="email" placeholder="hr@company.com" className={fieldCls(!!errors.email)}
              {...register('email', {
                required: 'Required',
                pattern: { value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: 'Invalid email' },
              })} />
          ...
          <div className="grid grid-cols-2 gap-4 pt-1 border-t border-gray-100">
            <div>
              ...
              <input type="password" placeholder="Min. 8 characters" className={fieldCls(!!errors.password)}
                {...register('password', {
                  required: 'Required',
                  minLength: { value: 8, message: 'Min 8 characters' },
                })} />
    ...
    <div className="max-w-7xl mx-auto space-y-6">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50/80">
                    {[
                      ['Employee', 'text-left'], ['Email', 'text-left'], ['Mobile', 'text-left'],
                      ['Title', 'text-left'], ['Department', 'text-left'], ['Status', 'text-left'],
                      ['Onboarding', 'text-left'], ['Tenure', 'text-left'], ['Actions', 'text-right'],
                    ].map(([h, align]) => (
                      <th key={h} className={`px-4 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wide ${align}`}>
                        {h}
                      </th>
                    ))}
                  </tr>
      ...
      {addOpen && (
        <EmployeeModal
          ...
          onClose={() => setAddOpen(false)} onSuccess={handleSuccess}
        />
      )}
      {editTarget && (
        <EmployeeModal
          employee={editTarget} companies={companies} departments={departments} isAdmin={isAdmin}
          defaultCompanyId={user?.company_id ?? undefined}
          onClose={() => setEditTarget(null)} onSuccess={handleSuccess}
        />
      )}
      {deleteTarget && (
        <DeleteConfirmModal
